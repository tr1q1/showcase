	...
	public static void main(String[] args) {
		if (args.length > 0) {
			...
			if (
				...
				sql.append("SELECT VenueID, UserID");
				...
				Integer numResultados = 10;
				if (! StringUtils.isEmpty(parametrosEntrada.getProperty("NUM_RESULTS"))) {
					numResultados = Integer.valueOf(parametrosEntrada.getProperty("NUM_RESULTS"));
				}

				consulta.show(numResultados, false);

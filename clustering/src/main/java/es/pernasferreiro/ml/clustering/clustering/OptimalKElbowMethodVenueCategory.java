...
public class OptimalKElbowMethodVenueCategory {
...
//				      dataset = dataset.filter(col("VenueCategoryID").equalTo("4bf58dd8d48988d129951735").or(col("VenueCategoryID").equalTo("4bf58dd8d48988d103941735")).or(col("VenueCategoryID").equalTo("4bf58dd8d48988d1df941735")));
				}

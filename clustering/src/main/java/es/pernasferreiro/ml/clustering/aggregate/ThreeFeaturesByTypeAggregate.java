...
public class ThreeFeaturesByTypeAggregate {
	...
	public static void main(String[] args) throws java.text.ParseException {
		if (args.length > 0) {
			...
			if (
				...
				sql.append("SELECT VenueCategoryID, UserID, COUNT(*) AS VisitasTotales, (DATEDIFF(TO_DATE('" + startTime + "'), MAX(UTCTime))) AS DiasDesdeUltimaVisita, AVG((unix_timestamp(UTCTimeFin) - unix_timestamp(UTCTime)) / 60) AS MediaDuracionVisita ");
				...
				sql.append("GROUP BY VenueCategoryID, UserID ");

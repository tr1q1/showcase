...
def plot_results_dataset():
    ...
    coleccion = db["THREE_FEATURES_AGGREGATE_SUBWAY_BISECTINGKMEANS_TRAINNED"]
...
##        { "$match": { "VenueCategoryID" : "4bf58dd8d48988d122951735" } }, ## ELECTRONICS_STORE
    ...
    plt.subplot(111)
    plt.bar(cluster, mediaDuracionVisita)
    plt.xlabel('cluster')
    plt.ylabel('Media duracion visita')

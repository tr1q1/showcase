package es.pernasferreiro.smsgateway.es.pernasferreiro.smsgateway.utils;
...
{
	public static String FORMATO_FECHA_ESPANHOL = "dd-MM-yyyy";
	public static String FORMATO_FECHA_INGLES = "yyyy-MM-dd";
	public static String FORMATO_TIMESTAMP_ESPANHOL = "dd-MM-yyyy HH:mm:ss.SSS";
	public static String FORMATO_TIMESTAMP_INGLES = "yyyy-MM-dd HH:mm:ss.SSS";
